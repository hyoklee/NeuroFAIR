...
- [MiV case 6 — IOWarp core vs native HDF5 (ares, end-to-end)](miv_iowarp_ares_case6.md) — whole-application `run-network` comparison: IOWarp POSIX adapter ~15% slower on 1 node (compute-bound, read-once), multi-node deadlocks; native HDF5 scales to 2 nodes (1.76×)
